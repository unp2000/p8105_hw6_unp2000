...
```
    ...
    ##  1 <res… <res… 001   <lm>      <lm>      <lm>             438.        307.
    ##  2 <res… <res… 002   <lm>      <lm>      <lm>             449.        352.
    ##  3 <res… <res… 003   <lm>      <lm>      <lm>             440.        320.
    ##  4 <res… <res… 004   <lm>      <lm>      <lm>             449.        325.
    ##  5 <res… <res… 005   <lm>      <lm>      <lm>             448.        328.
    ##  6 <res… <res… 006   <lm>      <lm>      <lm>             463.        324.
    ##  7 <res… <res… 007   <lm>      <lm>      <lm>             450.        364.
    ##  8 <res… <res… 008   <lm>      <lm>      <lm>             459.        341.
    ##  9 <res… <res… 009   <lm>      <lm>      <lm>             437.        344.
    ## 10 <res… <res… 010   <lm>      <lm>      <lm>             443.        342.
...
data. Model 1, my predicted model has a high RMSE value which indicates
that it doesn’t fit the data appropriately. Model 2 which includes some
of the parameters from Model 3 has an RMSE value in the middle which
shows that it fits the data better than Model 1 but not as well as Model
3.
