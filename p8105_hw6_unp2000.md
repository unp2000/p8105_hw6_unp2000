...
```
    ...
    ##  1 <res… <res… 001   <lm>      <lm>      <lm>             447.        325.
    ##  2 <res… <res… 002   <lm>      <lm>      <lm>             444.        322.
    ##  3 <res… <res… 003   <lm>      <lm>      <lm>             447.        332.
    ##  4 <res… <res… 004   <lm>      <lm>      <lm>             460.        332.
    ##  5 <res… <res… 005   <lm>      <lm>      <lm>             448.        327.
    ##  6 <res… <res… 006   <lm>      <lm>      <lm>             463.        332.
    ##  7 <res… <res… 007   <lm>      <lm>      <lm>             446.        326.
    ##  8 <res… <res… 008   <lm>      <lm>      <lm>             473.        364.
    ##  9 <res… <res… 009   <lm>      <lm>      <lm>             446.        320.
    ## 10 <res… <res… 010   <lm>      <lm>      <lm>             459.        366.
...
Based on the assumption that our plots are approximately normal, we can
infer that 95% confidence interval for log(b0\*b1) based off the 2.5%
and 97.5% quantiles is approximately (1.925, 2.075)
...
Based on the assumption that our plots are approximately normal, we can
infer that the 95% confidence interval for r^2 based off the 2.5% and
97.5% quantiles is approximately (0.8875, 0.9375)
